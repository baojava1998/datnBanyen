        ...
        <div class="col-lg-4 col-sm-6">
            <div class="product-item">
                <div class="pi-pic">
                    ...
                    <ul>
                        <li class="w-icon active"><a href="javascript:" class="add_to_cart" data-hinh="{{$sp->sanpham->hinh[0]->Hinh}}" data-qty="1" data-url="themgio/{{ $sp->id }}"><i class="icon_bag_alt"></i></a></li>
